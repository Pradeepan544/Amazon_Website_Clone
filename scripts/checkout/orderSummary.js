...
export function renderOrderSummary(){
    ...
    //making the delete button in checkout page interactive
    document.querySelectorAll('.js-delete-link').forEach((link)=>{
        link.addEventListener('click', ()=>{
            ...
            //when deleting the product in checkout page, updating the order summary
            renderPaymentSummary();
    ...
    //calculating the cart quantity to display in the checkout header
