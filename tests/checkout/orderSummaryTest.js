...
describe('tests suite: renderOrderSummary', ()=>{
    ...
    const productId2='5b6fc6f-327a-4ec4-896f-486349e85a3d';
    ...
    beforeEach(()=>{
        ...
        `;
        //mocking the cart again since we load the cart from localstorage
    ...
    it('updates the delivery option', ()=>{
        ...
        expect(
            document.querySelector(`.js-delivery-option-${productId1}-3`).checked
        ).toEqual(true);
